...
public class FileStorageServices {
	...
	public FileStorageServices(FileStorageConfig fileStorageConfig) {
		...
		try {
			...
			throw new FileStorageException("Could not create the directory where the uploaded files will be storaged!", ex);
		}
	}
	...
	public String storeFile(MultipartFile file) {
		...
		try {
			...
			throw new FileStorageException("Could not store file " + fileName + ". Please tye again!", ex);
		}
	}
